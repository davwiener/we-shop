...
export const ACCOUNT_AUCTIONS_LOADED = "ACCOUNT_AUCTIONS_LOADED";
...
// cart 
export const ADD_AUCTION_TO_CART = "ADD_AUCTION_TO_CART";
export const REMOVE_AUCTION_FROM_CART = "REMOVE_AUCTION_FROM_CART";
export const CHANGE_PRICE_LEVEL = "CHANGE_PRICE_LEVEL";
