...
import * as productsActions from "../../redux/actions/auctions-actions";
...
function Auctions() {
  ...
  useEffect(() => {
    ...
    const newSearch =
      query.page === 1 || query.page === searchState.query?.page;
    dispatch(productsActions.search(query, newSearch));
  }, [searchState.filters]);
